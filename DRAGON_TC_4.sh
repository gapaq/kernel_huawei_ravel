...
#function make_kernel() {
  ...
  echo -e "***********************************************$nocol"
  PATH=/home/m03/TOOLCHAIN/DRAGON_TC_4/bin:/home/m03/TOOLCHAIN/LINARO_4.9/bin:${PATH} \
...
export KBUILD_COMPILER_STRING=$(/home/m03/TOOLCHAIN/DRAGON_TC_4/bin/clang --version | head -n 1 | perl -pe 's/\(http.*?\)//gs' | sed -e 's/  */ /g' -e 's/[[:space:]]*$//')
