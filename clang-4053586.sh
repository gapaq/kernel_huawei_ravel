...
#function make_kernel() {
  ...
  echo -e "***********************************************$nocol"
  PATH=/home/m03/TOOLCHAIN/clang-4053586/bin:/home/m03/TOOLCHAIN/aarch64-linux-android-4.9-clang/bin:${PATH} \
...
export KBUILD_COMPILER_STRING=$(/home/m03/TOOLCHAIN/clang-4053586/bin/clang --version | head -n 1 | perl -pe 's/\(http.*?\)//gs' | sed -e 's/  */ /g' -e 's/[[:space:]]*$//')
