...
#define DFMO_MIN_ANIMATION_BOOST_FREQ	(103750000)
#define DFMO_MAX_ANIMATION_BOOST_FREQ	(767000000)
#define DFMO_DEFAULT_ANIMATION_BOOST_FREQ	(415000000)
#define DFMO_OPENCL_BOOST_ON		(1)
#define DFMO_OPENCL_BOOST_DN		(1)
#define DFMO_MIN_OPENCL_BOOST_FREQ	(103750000)
#define DFMO_MAX_OPENCL_BOOST_FREQ	(767000000)
#define DFMO_DEFAULT_OPENCL_BOOST_FREQ	(550000000)
#define DFMO_MIN_HISPEED_FREQ		(103750000)
#define DFMO_MAX_HISPEED_FREQ		(767000000)
#define DFMO_DEFAULT_HISPEED_FREQ	(415000000)

#ifdef DFMO_REQUEST_QOS_CPU_DMA_LATENCY
#define DFMO_MIN_FREQ_FOR_QOS_CPU_DMA_LATENCY		(415000000)
#define DFMO_MAX_FREQ_FOR_QOS_CPU_DMA_LATENCY		(767000000)
#define DFMO_DEFAULT_FREQ_FOR_QOS_CPU_DMA_LATENCY	(767000000)
