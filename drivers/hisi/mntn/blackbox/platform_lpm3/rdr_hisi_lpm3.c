...
log_lpm3_cleartext_t g_lpm3_cleartext[] = {
		{"HEAD_INFO.txt", M3_RDR_SYS_CONTEXT_HEAD_SIZE},
		{"LPM3_CORE_REGS.txt", M3_RDR_SYS_CONTEXT_M3_COREREG_SIZE},
		{"LPM3_EXC_SPECIAL.txt", M3_RDR_SYS_CONTEXT_EXC_SPECIAL_SIZE},
		{"LPM3_NVIC_REGS.txt", M3_RDR_SYS_CONTEXT_M3_NVICREG_SIZE},
		{"CRG_PERI.txt", M3_RDR_CRG_PERI_SIZE},
		{"SCTRL.txt", M3_RDR_SCTRL_SIZE},
		{"PMCTRL.txt", M3_RDR_PMCTRL_SIZE},
		{"PCTRL.txt", M3_RDR_PCTRL_SIZE},
		{"LPM3_LOG.txt", M3_RDR_SYS_CONTEXT_M3_LOG_SIZE},
		{"RUNTIME_VAR.txt", M3_RDR_SYS_CONTEXT_RUNTIME_VAR_SIZE},
};
