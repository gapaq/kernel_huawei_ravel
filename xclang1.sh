...
export KBUILD_COMPILER_STRING=$(/home/m03/TOOLCHAIN/DRAGON_TC_8/bin/clang --version | head -n 1 | perl -pe 's/\(http.*?\)//gs' | sed -e 's/  */ /g' -e 's/[[:space:]]*$//')
...
make O=out ARCH=arm64 merge_kirin970_defconfig
...
make -j$(nproc --all) O=out ARCH=arm64 \
                      CC="/home/m03/TOOLCHAIN/DRAGON_TC_7/bin/clang" \
                      CLANG_TRIPLE="aarch64-linux-gnu-" \
                      CROSS_COMPILE="/home/m03/TOOLCHAIN/LINARO_4.9/bin/aarch64-linux-gnu-"
