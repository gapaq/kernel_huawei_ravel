...
#function make_kernel() {
  ...
  echo -e "***********************************************$nocol"
  PATH=/home/m03/TOOLCHAIN/r6-clang-4691093-Pie/bin:/home/m03/TOOLCHAIN/LINARO_4.9/bin:${PATH} \
...
export KBUILD_COMPILER_STRING=$(/home/m03/TOOLCHAIN/r6-clang-4691093-Pie/bin/clang --version | head -n 1 | perl -pe 's/\(http.*?\)//gs' | sed -e 's/  */ /g' -e 's/[[:space:]]*$//')
